...
const good = ["paid", "approved", "accepted", "converted", "confirmed", "completed", "published", "active", "verified", "finalized", "available"];
  ...
  return (
    <Badge
      className={cn(
        ...
        danger.includes(normalized) && "bg-[#FFE8E8] text-viaje-red before:bg-viaje-red",
